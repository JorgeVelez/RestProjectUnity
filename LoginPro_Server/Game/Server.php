...
else if($ACTION == "GetUsers") { include_once 'Includes/Actions/GetUsers.php'; }
else if($ACTION == "GetGroups") { include_once 'Includes/Actions/GetGroups.php'; }
else if($ACTION == "AddGroup") { include_once 'Includes/Actions/AddGroup.php'; }
else { include_once 'Includes/Actions/'.$ACTION.'.php'; }
/*************************** ACTIONS ZONE END ******************************/
