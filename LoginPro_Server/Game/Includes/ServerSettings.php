...
$_SESSION['SERVER_user'] = 'db112763_rastrea';
// Your password to connect to the database 
$_SESSION['SERVER_password'] = '@Rastrea1234';
// The name of your database
$_SESSION['DB_name'] = 'db112763_rastreadoras';
// The table where your accounts are saved
$_SESSION['AccountTable'] = 'Account';
// The table where your accounts are saved
$_SESSION['GruposTable'] = 'Grupos';
// The table where your achievements are saved
$_SESSION['GruposAsignacionUsuariosTable'] = 'GruposAsignacionUsuarios';
// The table where your achievements are saved
$_SESSION['BusquedasAsignacionUsuariosTable'] = 'BusquedasAsignacionUsuarios';
// The table where your achievements are saved
$_SESSION['TestimoniosTable'] = 'Testimonios';
// The table where your achievements are saved
$_SESSION['MediaTable'] = 'Media';
// The table where your achievements are saved
$_SESSION['CuestionarioTable'] = 'Cuestionario';
// The table where your achievements are saved
$_SESSION['CuestionarioPDTable'] = 'CuestionarioFamiliarDesaparecido';
// The table where your achievements are saved
$_SESSION['BusquedasTable'] = 'Busquedas';
// The table where your achievements are saved
$_SESSION['CuestionarioTable'] = 'Cuestionario';
// The table where your achievements are saved
$_SESSION['CuestionarioFamiliarDesaparecidoTable'] = 'CuestionarioFamiliarDesaparecido';
// The table where your achievements are saved
