...
namespace Lean.Touch
{
	...
	public class LeanFingerSwipeUI : MonoBehaviour, IPointerUpHandler
	{
		...
		private void FingerSwipe(LeanFinger finger)
		{
			...
			if (!RectTransformUtility.RectangleContainsScreenPoint(rectTransform, finger.ScreenPosition))
			{
				return;
			}
			...
			isPointerOnRect = false;

			Debug.Log("swiped: "+name);
