...
$query = "SELECT color FROM ".$_SESSION['GruposTable']." WHERE id = :id";
$parameters = array(':id' => $account['idGrupo']);
$stmt = ExecuteQuery($query, $parameters);
$grupo = $stmt->fetch(PDO::FETCH_ASSOC);

$urlImages = 'http://thisisnotanumber.org/rastreadoras/LoginPro_Server/Game/media/';
