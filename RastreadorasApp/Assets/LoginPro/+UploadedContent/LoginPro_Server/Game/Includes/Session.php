...
else if(isset($_GET['SID']))								// If a SID has been received
{
	session_id($_GET['SID']);
}
else														// Otherwise, check if the current page is authentification(only page where a new session can be created, except Message.php which is a special page)
{
