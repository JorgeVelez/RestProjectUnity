...
{
    public static class LoginPro_Security
    {
        ...
        /// Read the public certificate to fill modulus and exponent of the LoginPro_Session.
        /// </summary>
        public static void PrepareSecurityInformation()
        {
            // Generate AES keys (and save aes_key and aes_iv in LoginPro_Session)
            generateAESkeyAndIV(ref LoginPro.Session.AES_Key, ref LoginPro.Session.AES_IV);
            ...
            generateToken(ref LoginPro.Session.Session_token);

            // Read certificate to get the RSA public key (of the server) (and save publicModulus and publicExponent in LoginPro_Session)
            readPublicCertificate(ref LoginPro.Session.PublicModulus, ref LoginPro.Session.PublicExponent);
        }
        ...
        {
            string modulus = LoginPro.Session.PublicModulus;
            string exponent = LoginPro.Session.PublicExponent;
        ...
        public static string AES_encrypt(String input)
        {
            ...
            aes.Key = Convert.FromBase64String(LoginPro.Session.AES_Key);
            aes.IV = Convert.FromBase64String(LoginPro.Session.AES_IV);
        ...
        {
            token = LoginPro_Security.randomString(tokenSize);
        }
        ...
        /// <summary>
        /// String extension to convert a string to an user role
        /// </summary>
        ...
        {
            return (T)LoginPro_UserRole.Parse(typeof(T), value, true);
        }
