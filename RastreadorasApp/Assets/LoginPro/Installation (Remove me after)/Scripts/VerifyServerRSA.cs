...
namespace LoginProAsset
{
    public class VerifyServerRSA : MonoBehaviour
    {
        ...
        private IEnumerator openSSLSession()
        {
            ...
            string URLtoServer = "http://www.redeagleunity.com/ExternalRSACreation/Installation/CheckRSA.php";
            ...
            form.AddField("URL", readURLFromConfigurationFile());
            form.AddField("GameName", this.gameName);
            ...
            if (!string.IsNullOrEmpty(w.error) || w.text.Contains("ERROR")) //ERROR
            {
