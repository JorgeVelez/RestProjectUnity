...
public class GeoPoint{
	...
	{
		return string.Format ("{0},{1}", lon_d.ToString("R"), lat_d.ToString("R"));
	}
	public string ToUseStringBack ()
	{
		return string.Format ("{0},{1}", lat_d.ToString("R"), lon_d.ToString("R"));
	}

	public string ToUseStringLat ()
	{
		return string.Format ("{0}", lat_d.ToString("R"));
	}

	public string ToUseStringLon ()
	{
		return string.Format ("{0}", lon_d.ToString("R"));
	}
